...
(function(){
    ...
    var particleArr,x= 0,y= 0,xA= 0,yA= 0;
    ...
    function resize(){
        ...
        for(var i = 0;i<150 ;i++){
            ...
            //有正数也有负数,-1到1之间,不能为0;
            xA = (Math.random()-0.5)*2 != 0 ? (Math.random()-0.5)*2 : 0.9;
            yA = (Math.random()-0.5)*2 != 0 ? (Math.random()-0.5)*2 : 0.9;
            particleArr.push({x,y,xA,yA});
        }
    }
    resize();
    //5.监听屏幕尺寸变化
